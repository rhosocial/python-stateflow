...
class OrderTemplateStep(UUIDMixin, TimestampMixin, ActiveRecord):
    ...
    on_start_notify: Optional[dict] = None
    on_complete_notify: Optional[dict] = None
    on_rollback_notify: Optional[dict] = None
    on_timeout_notify: Optional[dict] = None
...
class AsyncOrderTemplateStep(UUIDMixin, TimestampMixin, AsyncActiveRecord):
    """Async sibling of :class:`OrderTemplateStep`."""
